...
namespace Web.Migrations.MyDb
{
    ...
    [Migration("20210617034152_新增文件上传属性")]
    partial class 新增文件上传属性
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iData.System.UpLoadFile", b =>
                {
                    ...
                    b.Property<int?>("SystemCheckResultId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SystemCheckResultId");
            ...
            modelBuilder.Entity("iData.System.UpLoadFile", b =>
                {
                    b.HasOne("iData.rs.SystemCheckResult", null)
                        .WithMany("UpLoadFiles")
                        .HasForeignKey("SystemCheckResultId");
                });
